package com.bank.bian.productdirectory.model;
...
/**
 * The BIAN control record for this service domain: "Product Reference Data Directory Entry".
 *
 ...
 * to its asset type (Product Reference Data). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Product Reference Data Directory Entry";
